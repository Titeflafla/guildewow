	 ...
	 */
   	...
   	public function getReputation($sort=FALSE,$sortfield='standing',$order='desc'){
   		...
   		foreach ($reputations as $key => $reputation){
   			...
   			$reputation['standing'] == 1 ? $reputations[$key]['standingName'] = 'En guerre':FALSE;
	   		$reputation['standing'] == 2 ? $reputations[$key]['standingName'] = 'Inamical ':FALSE;
	   		$reputation['standing'] == 3 ? $reputations[$key]['standingName'] = 'Neutre':FALSE;
	   		$reputation['standing'] == 4 ? $reputations[$key]['standingName'] = 'Amical':FALSE;
	   		$reputation['standing'] == 5 ? $reputations[$key]['standingName'] = 'Honor&eacute;':FALSE;
	   		$reputation['standing'] == 6 ? $reputations[$key]['standingName'] = 'R&eacute;v&eacute;r&eacute;':FALSE;
	   		$reputation['standing'] == 7 ? $reputations[$key]['standingName'] = 'Exalt&eacute;':FALSE;
   		}
   		if ($sort){
